...
func (_q *ServiceQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ServiceQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *ServiceQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ServiceQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *ServiceQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *ServiceQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
